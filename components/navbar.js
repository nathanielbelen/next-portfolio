...
const SocialItem = function ({ link, name, children }) {
  return (
    <nav
      className={`transition-colors duration-300 p-2 text-white w-11 rounded-xl  hover:bg-[#A2A7A9]`}
    >
      ...
      <div className='p-5 max-w-screen-lg m-auto' id='navbar'>
        <div className='flex items-center'>
          ...
          <div className='hidden md:flex flex-grow gap-5 px-10'>
            ...
            <SocialItem link='https://linkedin.com/in/nathanielbelen' name='LinkedIn'>
